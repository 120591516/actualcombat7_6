...
import com.wisely.actualcombat7_6.enumPackage.DownloadStatus;
import com.wisely.actualcombat7_6.enumPackage.UploadStatus;
...
public class ContinueFTP {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// String("歌曲".getBytes("GBK"),"iso-8859-1"));
			// myFtp.ftpClient.makeDirectory(new
			// String("爱你等于爱自己".getBytes("GBK"),"iso-8859-1"));
